        ...
        public class Service
        {
            ...
            public Task<Boolean> Connect()
            {
                try
                {
                    ...
                    {
                        ProtocolVersion = MqttProtocolVersion.Version_3_1_1 // 기본값 3.1.1, 버전이 맞아야 연결된다.
                    };
...
//endif
                    ...
                    mqttClient.Subscribe(new string[] { "pubmyEdukit" }, new byte[] { MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE });
            ...
            private void ConnectionStart(int DelayTime, XGTClass xGTClass, string ip, int port)
            {
                 ...
                 void MqttClient_MqttMsgPublishReceived(object sender, MqttMsgPublishEventArgs e)
                {
                    ...
                    if (test.tagId.Equals("1")) 
                    {
                        if (test.value.Equals("0")) //start
                        {
                            pAddress2.Address = "0";
                            pAddress2.Data = "0";
                            test1.Address = "22";
                            test1.Data = "0";
                            Console.WriteLine("tag : 1 - value : 0");
                        ...
                        else if (test.value.Equals("1")) // stop
                        {
                            pAddress2.Address = "0";
                            pAddress2.Data = "1";
                            test1.Address = "22";
                            test1.Data = "1";
                            Console.WriteLine("tag : 1 - value : 1");
                            xGTClass.Write(XGT_DataType.Bit, test1, XGT_MemoryType.IO_P, 0);
                            xGTClass.Write(XGT_DataType.Bit, pAddress2, XGT_MemoryType.SubRelay_M, 0);
                        }
                    }
                    else if (test.tagId.Equals("8")) // reset 
                    {
                        if (test.value.Equals("1"))
                        {
                            pAddress2.Address = "F";
                            pAddress2.Data = "1";
                            Console.WriteLine("tag : 8 - value : 1");
                            xGTClass.Write(XGT_DataType.Bit, pAddress2, XGT_MemoryType.SubRelay_M, 0);
                        }
                        else if (test.value.Equals("0"))
                        {
                            pAddress2.Address = "F";
                            pAddress2.Data = "0";
                            Console.WriteLine("tag : 8 - value : 0");
                            xGTClass.Write(XGT_DataType.Bit, pAddress2, XGT_MemoryType.SubRelay_M, 0);
                        }
                        pAddress2.Address = "F";
                        pAddress2.Data = "0";
